...
OUTPUT_DIR="/data/wjdu/Nov12/UniTS_HEAD_4_10"
MASTER_PORT=3112
...
CUDA_VISIBLE_DEVICES=$GPU python -u -m torch.distributed.launch --master_port=$MASTER_PORT --nproc_per_node=2 --use_env \
 train.py --data_config $DATA_CONFIG --load_path "$LOAD_PATH" --batch_size 512 \
 --epochs 400 --warmup_epochs 20 --blr 1e-3 --min_lr 1e-6 --weight_decay 5e-6 \
